...
#para baixar esse módulo, você precisa digitar 'mdc' na barra de pesquisa do windows e escrever 'pip installer mendeleev'. Ae só reiniciar o aplicativo. 
...
class Docente(pesquisador):
    ...
    #somente os docentes podem acessar/alterar os fornecedores dos metais
...
class Tecnico(pesquisador):
    ...
    #Essas funções servem para não dar erro
    def acessar_fornecedores(self,material):
...
#polímeros requerem alguns tipos de modos para serem processados
...
#Os materiais cerâmicos requerem alguns tipos de modos para serem processados
